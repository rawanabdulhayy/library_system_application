...
import 'package:library_system_application/business_logic/state_management/nav_bar/nav_bar_state.dart';
...
class SimpleNavBar extends StatelessWidget {
  ...
  Widget _buildItem({
    ...
    return Expanded(
      child: InkWell(
        // onTap: () => onTap(index),
        onTap: () => context.read<NavBarBloc>().add(NavBarItemSelected(index)),
